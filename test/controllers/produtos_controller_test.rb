...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { descricao: @produto.descricao, preco_unitario: @produto.preco_unitario, quantidade: @produto.quantidade } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { descricao: @produto.descricao, preco_unitario: @produto.preco_unitario, quantidade: @produto.quantidade } }
